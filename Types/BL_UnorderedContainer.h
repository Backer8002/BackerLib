...
/**
 * @brief Overwrites and sets element at index.
 * @param container Pointer to valid UnorderedContainer
 ...
 * @return ContainerAllocationFailure if allocation fails.
 */
 ...
 * @return ContainerInvalidSize if sizeOfElement was larger than the largestElement in the array. Only applicable if elementsArePointers is not set.
 * @return ContainerAllocationFailure if memory could not be allocated
 */
...
/**
 * @brief Assures atleast amount indexes are available.
 * @param container Pointer to valid UnorderedContainer
 * @param amount Amount of indexes that have to be ready
 * @return ContainerAllocationFailure if allocation fails.
 */
extern BL_ContainerError bl_unordered_container_reserve(BL_UnorderedContainer* container,size_t amount) noexcept;
...
extern bool                   bl_unordered_container_is_empty(const BL_UnorderedContainer* container) noexcept;
