...
#define noexcept
     ...
     */
    extern ContainerError    containerDynamicSizeCheckAdd(DynamicContainer* container) noexcept;
    /**
     ...
     */
    extern ContainerError    containerDynamicSizeCheckRemove(DynamicContainer* container) noexcept;
    /**
     ...
     */
    extern ContainerError    containerDynamicReserve(DynamicContainer* container, size_t amountOfIndexesToReserve) noexcept;
    /**
     * @brief Sets amount of elements used to 0 and resizes to 0 elements.
     * @param container Pointer to valid DynamicContainer
     */
    extern void              containerDynamicClear(DynamicContainer* container) noexcept;
    /**
     * @brief Removes the last element from the DynamicContainer.
     * @param container Pointer to valid DynamicContainer
     * @return ContainerInvalidIndex if there was no element to pop.
     */
    extern ContainerError    containerDynamicPop(DynamicContainer* container) noexcept;
    /**
     ...
     */
    extern ContainerError    containerDynamicRemove(DynamicContainer* container, size_t index, size_t lastIndex) noexcept;
    /**
     ...
     */
    extern ContainerError    containerDynamicInsert(DynamicContainer* container, size_t index, size_t amountOfElements, size_t sizeOfElement, const void* elements) noexcept;
    /**
     ...
     * @return ContainerAllocFailure if the array cannot grow for the new elements.
     */
    extern ContainerError    containerDynamicInsertContainer(DynamicContainer* container, size_t index, const Container* containerToInsert) noexcept;
    /**
     ...
     */
    extern ContainerError    containerDynamicAppend(DynamicContainer* container, size_t sizeOfElement, const void* element) noexcept;
    /**
     ...
     */
    extern DynamicContainer  containerConvertToDynamicStack(Container container) noexcept;
    /**
     ...
     */
    extern void*             containerDynamicFront(const DynamicContainer* container) noexcept;
    /**
     ...
     */
    extern void*             containerDynamicNext(const DynamicContainer* container, const void* element) noexcept;
    /**
     ...
     */
    extern void*             containerDynamicPrev(const DynamicContainer* container, const void* element) noexcept;
    /**
     ...
     */
    extern void*             containerDynamicBack(const DynamicContainer* container) noexcept;
    /**
     * @brief Returns pointer to the first invalid index in the container.
     * @param container Pointer to valid DynamicContainer
     * @return Pointer to the first invalid index in container.
     */
    extern void*             containerDynamicEnd(const DynamicContainer* container) noexcept;
